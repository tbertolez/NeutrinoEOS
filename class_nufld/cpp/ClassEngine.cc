   ...
   std::vector<double>& t_tot )
{
  ...
  d_nufld.assign( pt.k_size[index_md], 0.0 );
  ...
  t_nufld.assign( pt.k_size[index_md], 0.0 );
  ...
  call_perturb_sources_at_tau(index_md, 0, pt.index_tp_delta_nufld1, tau, &d_nufld[0]);
  ...
  call_perturb_sources_at_tau(index_md, 0, pt.index_tp_theta_nufld1, tau, &t_nufld[0]);
  ...
  for (int index_k=0; index_k<pt.k_size[index_md]; index_k++)
  {
    ...
    t_nufld[index_k] = (-alphak2 + t_nufld[index_k]) / fHa;
