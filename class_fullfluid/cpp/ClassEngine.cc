   ...
   std::vector<double>& t_tot )
{
  ...
  d_bltz.assign( pt.k_size[index_md], 0.0 );
  ...
  t_bltz.assign( pt.k_size[index_md], 0.0 );
  ...
  call_perturb_sources_at_tau(index_md, 0, pt.index_tp_delta_bltz1, tau, &d_bltz[0]);
  ...
  call_perturb_sources_at_tau(index_md, 0, pt.index_tp_theta_bltz1, tau, &t_bltz[0]);
  ...
  for (int index_k=0; index_k<pt.k_size[index_md]; index_k++)
  {
    ...
    t_bltz[index_k] = (-alphak2 + t_bltz[index_k]) / fHa;
