...
lcdm_pk  = class_pkout_to_df('class_nufld/output/explanatory00_pk.dat')
nufld_pk = class_pkout_to_df('class_nufld/output/default_nufld_pk.dat')
ncdm_pk  = class_pkout_to_df('class_nufld/output/default_ncdm_pk.dat')
...
axs_pk[1].plot(nufld_pk['k'], nufld_pk['P']/lcdm_pk['P']-1, label = "nufld")
axs_pk[1].plot(ncdm_pk['k'], ncdm_pk['P']/lcdm_pk['P']-1, label = "ncdm")
axs_pk[0].set_ylabel(r'$P(k)$')
axs_pk[1].set_ylabel(r'$P(k)/P_{\mathrm{exact}}(k)-1$')
axs_pk[0].set_xlabel(r'$k\ (h/\mathrm{Mpc})$')
axs_pk[1].set_xlabel(r'$k\ (h/\mathrm{Mpc})$')
axs_pk[1].set_xlim((1e-3,1))
# axs_pk[1].set_ylim((-0.1,0.2))
