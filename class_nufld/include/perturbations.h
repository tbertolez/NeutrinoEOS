...
enum nufldfa_flags {nufldfa_off, nufldfa_on};
...
enum nufldfa_method {nufldfa_mb,nufldfa_hu,nufldfa_CLASS,nufldfa_none};
...
struct perturbations
{
  ...
  short evolve_tensor_nufld;             /**< will we evolve nufld tensor perturbations (if we have nufld species and we use the exact method) ? */
  ...
  short has_source_delta_nufld; /**< do we need source for delta of all non-cold dark matter species with general Boltzmann hierarchy (e.g. massive neutrinos)? */
  ...
  short has_source_theta_nufld; /**< do we need source for theta of all non-cold dark matter species with general Boltzmann hierarchy (e.g. massive neutrinos)? */
  ...
  int index_tp_delta_nufld1; /**< index value for delta of first non-cold dark matter species (e.g. massive neutrinos) */
  ...
  int index_tp_theta_nufld1; /**< index value for theta of first non-cold dark matter species (e.g. massive neutrinos) */
...
struct perturbations_vector
{
  ...
  int* q_size_nufld;	/**< number of discrete momenta (for each nufld species) */
...
struct perturbations_workspace
{
  ...
  */
  ...
  double * delta_nufld;	/**< relative density perturbation of each nufld species */
  double * theta_nufld;	/**< velocity divergence theta of each nufld species */
  double * shear_nufld;	/**< shear for each nufld species */
  ...
  int index_ap_nufldfa; /**< index for nufld fluid approximation */
