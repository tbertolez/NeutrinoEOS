 ...
 * For models like ncdm or nufld, the code may decide to start the integration earlier.
 */
...
/**
 * Tolerance of relative deviation of the used non-cold dark matter with general Boltzmann hierarchy mass compared to that which would give the correct density.
 * The dark matter mass is estimated from the dark matter density using a Newton-Method.
 * In the nonrelativistic limit, this could be estimated using M=density/number density
 */
class_precision_parameter(tol_M_nufld,double,1.e-7)
/**
 * Tolerance on the relative precision of the integration over
 * non-cold dark matter phase-space distributions.
 */
class_precision_parameter(tol_nufld,double,1.e-3)
/**
 * Tolerance on the relative precision of the integration over
 * non-cold dark matter phase-space distributions in the synchronous gauge.
 */
class_precision_parameter(tol_nufld_synchronous,double,1.e-3)
/**
 * Tolerance on the relative precision of the integration over
 * non-cold dark matter phase-space distributions in the newtonian gauge.
 */
class_precision_parameter(tol_nufld_newtonian,double,1.e-5)
/**
 * Tolerance on the relative precision of the integration over
 * non-cold dark matter phase-space distributions during the background evolution.
 */
class_precision_parameter(tol_nufld_bg,double,1.e-5)
/**
 * Tolerance on the initial deviation of non-cold dark matter from being fully relativistic.
 * Using w = pressure/density, this quantifies the maximum deviation from 1/3. (for relativistic species)
 */
class_precision_parameter(tol_nufld_initial_w,double,1.e-3)
 ...
 * algorithms nufld_MOD: I don't know what this parameter is doing and if nufld should use it to, probably yes.
 */
...
class_precision_parameter(l_max_nufld,int,17)   /**< number of momenta in Boltzmann hierarchy for relativistic neutrino/relics (scalar), at least 4 */
...
class_precision_parameter(nufld_fluid_approximation,int,nufldfa_CLASS) /**< method for non-cold dark matter fluid approximation */
/**
...
/**
 * when to switch off nufld (massive neutrinos with generalized Boltzmann hierarchy / non-cold
 * relics) fluid approximation
 */
class_precision_parameter(nufld_fluid_trigger_tau_over_tau_k,double,31.0)
/**
